...
```Javascript
var a=["joble.in","skillcounty.com/assess/","corsit.in","s759labs.com","skillcounty.com"];var f=(t)=>()=>{a.length>0?window.open("http://"+a.shift(),"_blank"):t&&clearInterval(t)};f()();var t=setInterval(f(t),7000);
```
